...
// Adapted from: https://github.com/RevenantX/LiteNetLib/blob/master/LiteNetLib/Utils/NetDataReader.cs
public class DBReader
{
    ...
    public DBReader(byte[] source)
    {
        SetSource(source);
    }

    public DBReader(byte[] source, int offset, int maxSize)
    {
